...
Swasth Setu is an offline-first, AI-assisted rural healthcare coordination platform for ASHA workers and THO officers. Built with Flutter, it supports multilingual triage, frontline patient workflows, and district-level outbreak monitoring in low-connectivity environments.
...
Swasth Setu is built to remain functional during network interruptions:
...
- `https://swasth-setu.onrender.com`

## Hackathon Focus

Swasth Setu is built around practical AI for social good:
